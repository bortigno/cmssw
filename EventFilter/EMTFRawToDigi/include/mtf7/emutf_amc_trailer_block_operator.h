#ifndef __MTF7_EMUTF_AMC_TRAILER_OPERATOR__
#define __MTF7_EMUTF_AMC_TRAILER_OPERATOR__
...
namespace mtf7{
  ...
  class emutf_amc_trailer_block_operator: public emutf_block_operator{

  public:

    // Minimal constructor with only error value.
    emutf_amc_trailer_block_operator ( error_value *error_status ): 
		emutf_block_operator( error_status ) {}

  	// Constructor with event info to unpack for higher level operations.
    emutf_amc_trailer_block_operator ( error_value *error_status, emutf_event *unpacked_event_info ): 
		emutf_block_operator( error_status, unpacked_event_info ) {}

    // Constructor with event info to pack for higher level operations.
    emutf_amc_trailer_block_operator ( error_value *error_status, const emutf_event *event_info_to_pack ): 
