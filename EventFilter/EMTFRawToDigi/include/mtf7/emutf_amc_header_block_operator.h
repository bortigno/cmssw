#ifndef __MTF7_EMUTF_AMC_HEADER_BLOCK_OPERATOR__ 
#define __MTF7_EMUTF_AMC_HEADER_BLOCK_OPERATOR__
...
namespace mtf7{
  ...
  class emutf_amc_header_block_operator: public emutf_block_operator{

  public:

    emutf_amc_header_block_operator ( error_value *error_status ):
        emutf_block_operator( error_status ) {}

    emutf_amc_header_block_operator ( error_value *error_status, emutf_event *unpacked_event_info ):
        emutf_block_operator( error_status, unpacked_event_info ) {}
    
    emutf_amc_header_block_operator ( error_value *error_status, const emutf_event *_event_info_to_unpack ):
